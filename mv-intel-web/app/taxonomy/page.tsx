...
import { ChevronRight, ChevronDown, Search, Folder, Tag, Layers, Building2, Zap, FolderOpen, ArrowRight, LayoutGrid, List } from 'lucide-react';

// Taxonomy Data Structure (Same as before)
const TAXONOMY_DATA = {
  'IFT': {
    label: 'Investment Taxonomy',
    description: 'Root classification for all investment entities',
    children: {
      'PAY': {
        label: 'Payments',
        ...
        children: {
          'COM': { 
            label: 'Commercial', 
            children: { 
              'GATEWAY': { label: 'Payment Gateway', description: 'Online payment processing services' }, 
          ...
          'OPSF': { 
            ...
            children: { 
              'MONEY_TRANSFER': { label: 'Money Transfer', description: 'P2P and remittance services' }, 
      ...
      'DBK': {
        ...
        children: {
            'RETAIL': { 
              ...
              children: { 
                'NEO_BANK': { label: 'Neo Bank', description: 'Digital-first retail banks' } 
              } 
            },
            'MSME': { 
              label: 'MSME Banking', 
              children: { 
                'NEO_BANK': { label: 'Neo Bank', description: 'Digital banks for small businesses' } 
              } 
            },
            'BAAS': { label: 'Banking as a Service', description: 'White-label banking infrastructure' }
        }
      },
      'LEN': {
          label: 'Lending',
          ...
          children: {
              'BSL': { 
                ...
                children: { 
                  'BUSINESS': { label: 'Business Lending' }, 
                  'CONSUMER': { label: 'Consumer Lending' }, 
                  'PROPERTY': { label: 'Mortgage & Property' } 
                } 
              },
              'P2P': { 
                label: 'Peer to Peer', 
                children: { 
                  'BUSINESS': { label: 'Business P2P' } 
                } 
              },
              'CASHADV': { 
                label: 'Cash Advance', 
                children: { 
                  'CUSTOMER': { label: 'BNPL / Customer' }, 
                  'MERCHANT': { label: 'Merchant Cash Advance' } 
                } 
              },
              'DEBTSEC': { 
                label: 'Debt Securities', 
                children: { 
                  'INVOICE_TRADING': { label: 'Invoice Trading' } 
                } 
              }
          }
      },
      ...
      'WLT': {
          ...
          children: {
              'FO': { 
                label: 'Front Office', 
                children: { 
                  'CRM': { label: 'Wealth CRM' }, 
                  'INVEST': { label: 'Investment Platforms', description: 'Robo-advisors and trading apps' } 
                } 
              },
              'BO': { 
                label: 'Back Office', 
                children: { 
                  'PMS': { label: 'Portfolio Management Systems' } 
                } 
              }
          }
      },
              ...
              'EXCH': { 
                ...
                children: { 
                  'TRADE': { 
                    label: 'Trading', 
                    children: { 
                      'ORDERBOOK': { label: 'Orderbook Exchange' } 
                    } 
                  } 
                } 
              },
              'CUST': { 
                ...
                children: { 
                  'INST': { 
                    label: 'Institutional', 
                    children: { 
                      'THIRD_PARTY': { label: 'Third Party Custody' } 
                    } 
                  } 
                } 
              },
      ...
      'INS': {
          ...
          children: {
              'USAGE_BASED': { label: 'Usage Based Insurance' },
              'PARAMETRIC': { label: 'Parametric Insurance' },
              'ON_DEMAND': { label: 'On-Demand Insurance' }
          }
      },
      'RCI': {
