...
// Import defaults - we can't use import syntax in this script easily without ts-node config for aliases
// So we will just hardcode the values or rely on the user running this via a method that supports it.
// Given the environment constraints, I'll define the prompts here directly to ensure it runs standalone.
// This duplicates the content but ensures reliability for this specific "seed" task.
