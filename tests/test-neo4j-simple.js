...
async function testNeo4jConnection() {
  ...
  if (!NEO4J_URI || !NEO4J_USER || !NEO4J_PASSWORD) {
    ...
    console.log('Please check your .env.local file in mv-intel-web directory');
    process.exit(1);
  }
  ...
  try {
    ...
    console.log('\nNext steps:');
    console.log('1. Run migration: cd mv-intel-web && npm run migrate:neo4j');
    ...
    console.log('\nTroubleshooting:');
    console.log('1. Check your .env.local file in mv-intel-web directory');
