-- Knowledge Graph V2 Complete Schema Migration
-- This creates the comprehensive graph schema with all enrichment fields
...
DROP TABLE IF EXISTS graph.edges CASCADE;
