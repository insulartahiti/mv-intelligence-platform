-- Implement Option B: text-embedding-3-large (3072 dimensions) + HNSW indexes
...
-- Performance optimization: Set HNSW search parameters
-- These can be adjusted based on your query performance needs
ALTER SYSTEM SET hnsw.ef_search = 40; -- Higher = more accurate but slower
ALTER SYSTEM SET hnsw.ef_construction = 64; -- Higher = better quality but slower build
