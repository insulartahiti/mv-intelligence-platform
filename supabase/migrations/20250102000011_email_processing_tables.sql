...
DROP POLICY IF EXISTS "Users can view email analysis" ON email_analysis;
CREATE POLICY "Users can view email analysis" ON email_analysis
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Users can insert email analysis" ON email_analysis;
CREATE POLICY "Users can insert email analysis" ON email_analysis
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update email analysis" ON email_analysis;
CREATE POLICY "Users can update email analysis" ON email_analysis
  FOR UPDATE USING (true);

-- RLS policies for email_inbox
DROP POLICY IF EXISTS "Users can view email inbox" ON email_inbox;
CREATE POLICY "Users can view email inbox" ON email_inbox
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Users can insert email inbox" ON email_inbox;
CREATE POLICY "Users can insert email inbox" ON email_inbox
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update email inbox" ON email_inbox;
...
DROP POLICY IF EXISTS "Users can update email attachments" ON email_attachments;
CREATE POLICY "Users can update email attachments" ON email_attachments
  FOR UPDATE USING (true);

-- RLS policies for email_insights
DROP POLICY IF EXISTS "Users can view email insights" ON email_insights;
CREATE POLICY "Users can view email insights" ON email_insights
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "Users can insert email insights" ON email_insights;
CREATE POLICY "Users can insert email insights" ON email_insights
  FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update email insights" ON email_insights;
...
DROP TRIGGER IF EXISTS update_email_inbox_updated_at ON email_inbox;
