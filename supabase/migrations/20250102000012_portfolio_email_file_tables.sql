...
DROP POLICY IF EXISTS "Users can view portfolio emails for their companies" ON portfolio_emails;
...
DROP POLICY IF EXISTS "Users can insert portfolio emails" ON portfolio_emails;
...
DROP POLICY IF EXISTS "Users can update portfolio emails" ON portfolio_emails;
...
DROP POLICY IF EXISTS "Users can delete portfolio emails" ON portfolio_emails;
...
DROP POLICY IF EXISTS "Users can view portfolio files for their companies" ON portfolio_files;
CREATE POLICY "Users can view portfolio files for their companies" ON portfolio_files
  FOR SELECT USING (true); -- Adjust based on your auth requirements

DROP POLICY IF EXISTS "Users can insert portfolio files" ON portfolio_files;
CREATE POLICY "Users can insert portfolio files" ON portfolio_files
  FOR INSERT WITH CHECK (true); -- Adjust based on your auth requirements

DROP POLICY IF EXISTS "Users can update portfolio files" ON portfolio_files;
CREATE POLICY "Users can update portfolio files" ON portfolio_files
  FOR UPDATE USING (true); -- Adjust based on your auth requirements

DROP POLICY IF EXISTS "Users can delete portfolio files" ON portfolio_files;
...
DROP POLICY IF EXISTS "Users can upload portfolio files" ON storage.objects;
CREATE POLICY "Users can upload portfolio files" ON storage.objects
  FOR INSERT WITH CHECK (bucket_id = 'portfolio-files');

DROP POLICY IF EXISTS "Users can update portfolio files" ON storage.objects;
CREATE POLICY "Users can update portfolio files" ON storage.objects
  FOR UPDATE USING (bucket_id = 'portfolio-files');

DROP POLICY IF EXISTS "Users can delete portfolio files" ON storage.objects;
...
DROP TRIGGER IF EXISTS update_portfolio_emails_updated_at ON portfolio_emails;
